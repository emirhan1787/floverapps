    ...
    <div className='mainDiv'>
        ...
        <div className='rightColumn'>
            <div className='descDiv'>
                <span className='h2'>Stylish bouquets by florists</span>
                <span className='text'>
            ...
            <div className='descDiv'>
                <span className='h2'>On-time delivery</span>
                <span className='text'>
            ...
            <div className='descDiv'>
                <span className='h2'>Safe payment</span>
                <span className='text'>
            ...
            <div className='descDiv'>
                <span className='h2'>Subscription by your needs</span>
                <span className='text'>
